...
public class HighBloodPressure extends BaseTest {
	...
	public static void highBloodPressure() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//input[@id='ctl00_txtsearch']")).sendKeys("Cinnamon High Blood Pressure");
		...
		ExcelReader xlreader = new ExcelReader(".\\datafiles\\HighBloodPressure.xlsx");
		xlreader.setcelldata("Cinnamon ", 0, 0, "recipeid");
		xlreader.setcelldata("Cinnamon ", 0, 1, "recipename");
		xlreader.setcelldata("Cinnamon ", 0, 2,"Food Category(Veg/non-veg/vegan/Jain)");
		xlreader.setcelldata("Cinnamon ", 0, 3, "ingrediant");
		xlreader.setcelldata("Cinnamon ", 0, 4, "preparation Time");
		xlreader.setcelldata("Cinnamon ", 0, 5, "cook Time");
        xlreader.setcelldata("Cinnamon ", 0, 6, "preparation method");
		xlreader.setcelldata("Cinnamon ", 0, 7, "Nutrients");
		xlreader.setcelldata("Cinnamon ", 0,8,"Targetted morbid conditions");
		xlreader.setcelldata("Cinnamon ", 0, 9, "Url");
				
				for (int a = 0; a <=recipeName.size(); a++) 
				{
					try
					{
					xlreader.setcelldata("Cinnamon ", a+1, 0, recipeid.get(a));
					xlreader.setcelldata("Cinnamon ", a+1, 1, recipeName.get(a));

					xlreader.setcelldata("Cinnamon ", a+1, 2,foodCategory);
					xlreader.setcelldata("Cinnamon ", a+1, 3, ingredientList.get(a));

					xlreader.setcelldata("Cinnamon ", a+1, 4, prepTime.get(a));
					xlreader.setcelldata("Cinnamon ", a+1, 5, cookTime.get(a));
					xlreader.setcelldata("Cinnamon ", a+1, 6, prepMethod.get(a)); 
					xlreader.setcelldata("Cinnamon ", a+1, 7, NutrientList.get(a));
					xlreader.setcelldata("Cinnamon ", a+1,8, morbidities);
				    xlreader.setcelldata("Cinnamon ", a+1, 9, RecipeUrlList.get(a));
					}
					catch(Exception e)
					{
