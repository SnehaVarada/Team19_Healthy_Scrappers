...
public class Diabetes extends BaseTest
{
	...
	@Test
	public static void Diabetes_test() throws InterruptedException, IOException {
		...
		for (int p = 1; p <= 3; p++) {
		   ...
		   driver.findElement(By.xpath("//div[@id='cardholder']//div[3]//a[\" + p + \"]")).click();
...

			{
				...
				boolean isIngrediant = Diabetes_list.checkIngrediant(Ingrediants);
		...
		ExcelReader xlreader = new ExcelReader(".\\datafiles\\Diabetes_eliminated.xlsx");
